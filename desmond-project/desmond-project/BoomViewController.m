...
-(NSString*)getRandomFunnyMessage{
    NSMutableArray* messages = [[NSMutableArray alloc] initWithObjects:@"Justin Bieber will never sign again :(!",@"You have killed all the Pandas", @"Are you Mayan?", @"What about global warming??", nil];
